...
## 8. 
**NOTE**: These are steps the need to be run the directory `~/Games/<your-command-conquer-generals-zero-hour-install-folder>/drive_c/Program Files (x86)/R.G. Mechanics/Command and Conquer - Generals/Command and Conquer Generals Zero Hour/`
